function r=three_parts_dynamics_function(x,u)
   ...
   B=[d(1,1,P_g,S_g), zeros(2,1), zeros(2,1);
        1, 0, 0;
       d(2,1,P_g,S_g), d(2,2,P_g,S_g), zeros(2,1);
          1, 1,0;
       d(3,1,P_g,S_g), d(3,2,P_g,S_g),d(3,3,P_g,S_g) ;
       1,1,1];  

   Bdot=[d_dot(1,1,P_g,S_g,fidot), zeros(2,1), zeros(2,1);
        0, 0, 0;
       d_dot(2,1,P_g,S_g,fidot), d_dot(2,2,P_g,S_g,fidot), zeros(2,1);
          0, 0,0;
       d_dot(3,1,P_g,S_g,fidot), d_dot(3,2,P_g,S_g,fidot),d_dot(3,3,P_g,S_g,fidot) ;
       0,0,0];
