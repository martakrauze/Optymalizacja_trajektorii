...
#Przybliżenie początkowe przez interpolację
#load plik.mat
#k = rows(x)/9;
#tp=[0:T/(k-1):T]';
#theta10 = interp1(tp, x([1:k]), t');
#theta20 = interp1(tp, x([k+1:2*k]), t');
#theta30 = interp1(tp, x([2*k+1:3*k]), t');
...
#clear x
#x0 = [theta10; theta20; theta30; v10; v20; v30; u10; u20; u30];
...
#save three_parts_results.mat x
save three_parts_results.mat x
